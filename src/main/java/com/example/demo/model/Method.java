...
public class Method {
	...
	public Method(Repository repository, Committer committer, String name, java.lang.Class itsclass, String content,
                  Boolean ifNew, Boolean ifChanged, Boolean fDeleted, List<String> inheritancerelashionship) {
		super();
