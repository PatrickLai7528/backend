...
public class FileTreeNode {
	...
	private String gitHubUrl;// "https://api.github.com/repos/PatrickLai7528/android-chat-in-4-patterns/git/blobs/3d82d128859b45fadcc57fad533f053a8447afc5"
	private String content; // 如果Type為FOLDER，則為NULL
	private FileTreeNode[] subTrees;// Or Null，如果Type為FILE，則為NULL

	public FileTreeNode(String path, Enum type, String sha, String gitHubUrl, String content, FileTreeNode[] subTrees) {
		super();
		this.path = path;
		this.type = type;
		this.sha = sha;
