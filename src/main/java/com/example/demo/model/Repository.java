...
public class Repository {
	...
	public Repository(Map<String, FileTreeNode[]> fileTrees, Requirement requirement, Branch[] branches,
			String defaultBranch, Number forks, Number stars, String fullName, String name, Boolean ifPrivate,
			String id, String description, String homepage, Date createdAt, Date updatedAt, String gitHubUrl,
			String language) {
		super();
